 ...
 * Imagine 5 classrooms (sessions), each with 3 students (clients).
 * Every student shouts a message 20 times per second.
 * We measure: how fast does the server shout back? Does it get tired?
 *
 * HOW TO RUN:
 *   cd backend
 *   npm install ws
 ...
 *
 * WHAT YOU NEED FIRST:
 *   Your server must be running: node server.js
 */
